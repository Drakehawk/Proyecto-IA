...
public class ReLogoTurtle extends BaseTurtle{
	...
	/**
	 * Makes a number of new zombieHosts and then executes a set of commands on the
	 * created zombieHosts.
	 * 
	 * @param number
	 *            a number
	...
	public AgentSet<ddosattack.relogo.ZombieHost> hatchZombieHosts(int number, Closure closure) {
		AgentSet<ddosattack.relogo.ZombieHost> result = new AgentSet<>();
		AgentSet<Turtle> createResult = this.hatch(number,closure,"ZombieHost");
	 ...
	 */
	@ReLogoBuilderGeneratedFor("ddosattack.relogo.ZombieHost")
	public AgentSet<ddosattack.relogo.ZombieHost> hatchZombieHosts(int number) {
		return hatchZombieHosts(number,null);
	}
	...
	public AgentSet<ddosattack.relogo.UserTurtle> hatchUserTurtles(int number, Closure closure) {
	 ...
	 */
	@ReLogoBuilderGeneratedFor("ddosattack.relogo.UserTurtle")
	public AgentSet<ddosattack.relogo.UserTurtle> hatchUserTurtles(int number) {
	...
	/**
	 * Makes a number of new servers and then executes a set of commands on the
	 * created servers.
	 * 
	 * @param number
	 *            a number
	...
	public AgentSet<ddosattack.relogo.Server> hatchServers(int number, Closure closure) {
		AgentSet<ddosattack.relogo.Server> result = new AgentSet<>();
		AgentSet<Turtle> createResult = this.hatch(number,closure,"Server");
		for (Turtle t : createResult){
	 ...
	 */
	@ReLogoBuilderGeneratedFor("ddosattack.relogo.Server")
	public AgentSet<ddosattack.relogo.Server> hatchServers(int number) {
		return hatchServers(number,null);
	}
	...
	/**
	 * Makes a number of new hosts and then executes a set of commands on the
	 * created hosts.
	 * 
	 * @param number
	 *            a number
	...
	public AgentSet<ddosattack.relogo.Host> hatchHosts(int number, Closure closure) {
		AgentSet<ddosattack.relogo.Host> result = new AgentSet<>();
		AgentSet<Turtle> createResult = this.hatch(number,closure,"Host");
		for (Turtle t : createResult){
	 ...
	 */
	@ReLogoBuilderGeneratedFor("ddosattack.relogo.Host")
	public AgentSet<ddosattack.relogo.Host> hatchHosts(int number) {
		return hatchHosts(number,null);
	}
	...
	public ddosattack.relogo.UserLink createUserLinkFrom(Turtle t, Closure closure){
		ddosattack.relogo.UserLink link = (ddosattack.relogo.UserLink)this.getMyObserver().getNetwork("UserLink").addEdge(t,this);
		if (closure != null){
	 ...
	 */
	@ReLogoBuilderGeneratedFor("ddosattack.relogo.UserLink")
	public ddosattack.relogo.UserLink createUserLinkFrom(Turtle t){
	 ...
	 */
	@ReLogoBuilderGeneratedFor("ddosattack.relogo.UserLink")
	public AgentSet<ddosattack.relogo.UserLink> createUserLinksFrom(Collection<? extends Turtle> a, Closure closure){
		AgentSet<ddosattack.relogo.UserLink> links = new AgentSet<ddosattack.relogo.UserLink>();
		for(Turtle t : a){
			links.add((ddosattack.relogo.UserLink)this.getMyObserver().getNetwork("UserLink").addEdge(t,this));
		}
		if (closure != null){
	 ...
	 */
	@ReLogoBuilderGeneratedFor("ddosattack.relogo.UserLink")
	public AgentSet<ddosattack.relogo.UserLink> createUserLinksFrom(Collection<? extends Turtle> a){
	 ...
	 */
	@ReLogoBuilderGeneratedFor("ddosattack.relogo.UserLink")
	public ddosattack.relogo.UserLink createUserLinkTo(Turtle t, Closure closure){
		ddosattack.relogo.UserLink link = (ddosattack.relogo.UserLink)this.getMyObserver().getNetwork("UserLink").addEdge(this,t);
		if (closure != null){
			this.ask(link,closure);
		}
		return link;
	 ...
	 */
	@ReLogoBuilderGeneratedFor("ddosattack.relogo.UserLink")
	public ddosattack.relogo.UserLink createUserLinkTo(Turtle t){
	 ...
	 */
	@ReLogoBuilderGeneratedFor("ddosattack.relogo.UserLink")
	public AgentSet<ddosattack.relogo.UserLink> createUserLinksTo(Collection<? extends Turtle> a, Closure closure){
		AgentSet<ddosattack.relogo.UserLink> links = new AgentSet<ddosattack.relogo.UserLink>();
		for(Object t : a){
			if (t instanceof Turtle){
				links.add((ddosattack.relogo.UserLink)this.getMyObserver().getNetwork("UserLink").addEdge(this,(Turtle)t));
			}
		}
		if (closure != null){
			this.ask(links,closure);
	 ...
	 */
	@ReLogoBuilderGeneratedFor("ddosattack.relogo.UserLink")
	public AgentSet<ddosattack.relogo.UserLink> createUserLinksTo(Collection<? extends Turtle> a){
	 ...
	 */
	@ReLogoBuilderGeneratedFor("ddosattack.relogo.UserLink")
	public ddosattack.relogo.UserLink inUserLinkFrom(Turtle t){
		return (ddosattack.relogo.UserLink)this.getMyObserver().getNetwork("UserLink").getEdge(t,this);
	}
	 ...
	 */
	@ReLogoBuilderGeneratedFor("ddosattack.relogo.UserLink")
	public AgentSet<ddosattack.relogo.UserLink> myInUserLinks(){
		AgentSet<ddosattack.relogo.UserLink> result = new AgentSet<ddosattack.relogo.UserLink>();
		for(Object o :  this.getMyObserver().getNetwork("UserLink").getInEdges(this)){
			if (o instanceof ddosattack.relogo.UserLink){
				result.add((ddosattack.relogo.UserLink) o);
			}
		}
		return result;
	}
	 ...
	 */
	@ReLogoBuilderGeneratedFor("ddosattack.relogo.UserLink")
	public AgentSet<ddosattack.relogo.UserLink> myOutUserLinks(){
		AgentSet<ddosattack.relogo.UserLink> result = new AgentSet<ddosattack.relogo.UserLink>();
	 ...
	 */
	@ReLogoBuilderGeneratedFor("ddosattack.relogo.UserLink")
	public ddosattack.relogo.UserLink outUserLinkTo(Turtle t){
		return (ddosattack.relogo.UserLink)this.getMyObserver().getNetwork("UserLink").getEdge(this, t);
	}
	 ...
	 */
	@ReLogoBuilderGeneratedFor("ddosattack.relogo.UserLink")
	public AgentSet<ddosattack.relogo.UserLink> myUserLinks(){
		AgentSet<ddosattack.relogo.UserLink> result = new AgentSet<ddosattack.relogo.UserLink>();
